...
void loop() {
    ...
    if (currentMode == "Manual") {
        // Obey user cloud overrides (Active-LOW Relays: LOW = ON, HIGH = OFF)
        ...
        digitalWrite(LIGHT_RELAY_PIN, statusLight == "ON" ? LOW : HIGH);
    } else {
        ...
        // [AUTOMATED GROW LIGHT CONTROL]: Turns ON if light drops below threshold
